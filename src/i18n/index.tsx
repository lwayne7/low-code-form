...
const zhCN = {
  ...
  // Header
  'header.title': 'FormCraft',
  'header.subtitle': '可视化表单构建器',
  'header.undo': '撤销',
  'header.redo': '重做',
  'header.history': '操作历史',
  'header.clear': '清空画布',
  ...
  'propertyPanel.expressionWarning.typeMismatch':
    '类型可能不匹配：{key} 期望 {expected}，但表达式中按 {actual} 使用（{operator}）',
  ...
  // Footer
  'footer.createdBy': '由 LWayne 创建',
  'footer.builtWith': '使用 React + TypeScript 构建',
  'footer.version': '版本',
...
const enUS: Translations = {
  ...
  // Header
  'header.title': 'FormCraft',
  'header.subtitle': 'Visual Form Builder',
  'header.undo': 'Undo',
  'header.redo': 'Redo',
  ...
  'errorBoundary.description':
    'Sorry, the application encountered an issue. You can try refreshing the page or resetting the app.',
  ...
  'propertyPanel.gridColumnsTooltip':
    'Number of grid columns inside the container for child component layout',
  ...
  'propertyPanel.expressionWarning.typeMismatch':
    'Possible type mismatch: {key} expects {expected}, but expression uses {actual} ({operator})',
  ...
  // Footer
  'footer.createdBy': 'Created by LWayne',
